...
export const SpookyEnvironment: React.FC<Props> = ({
  ...
  return (
    ...
    {/* JUMPSCARE OVERLAY: Always rendered outside ambient container at root level with z-[9999] in front of all game screens */}
    <AnimatePresence>
      {showBoo && (
        <motion.div
          ...
          className="fixed inset-0 flex items-center justify-center z-[9999] pointer-events-auto bg-black/75 backdrop-blur-sm"
        >
          <div className="relative flex flex-col items-center bg-purple-900 border-4 border-yellow-400 p-8 rounded-3xl shadow-[0_0_90px_rgba(234,179,8,1)] text-center animate-bounce max-w-sm mx-4">
